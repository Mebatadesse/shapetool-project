package com.project.shapetool.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema shapesSchema) {
        ...
        wsdl11Definition.setPortTypeName("ShapeToolPort");
        wsdl11Definition.setLocationUri("/ws/shapetool");
        wsdl11Definition.setTargetNamespace("http://shapetool.com/soap");
